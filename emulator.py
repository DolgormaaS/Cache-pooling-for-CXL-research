...
class MetadataCache(Cache):
    def __init__(self, range_start, range_end, capulet=False):
        ...
        super(MetadataCache, self).__init__(64 << 10, 4)
...
class CAPULET:
    def __init__(self, num_hosts, workloads):
        ...
        for i, workload in enumerate(workloads):
            self.hosts.append(Host(workload, MEM_SIZE * i * 2, (MEM_SIZE * i * 2) + MEM_SIZE, 10000000 if workload == 'random' else 0, capulet=True))
